...
label_szczegoly_wartosc.grid(row=1, column=2)
label_szczegoly_surname=Label(ramka_szczegoly_obiektow, text="Nazwisko: ")
label_szczegoly_surname.grid(row=1, column=3)
label_szczegoly_wartosc=Label(ramka_szczegoly_obiektow, text="....")
label_szczegoly_wartosc.grid(row=1, column=4)
label_szczegoly_location=Label(ramka_szczegoly_obiektow, text="Lokalizacja: ")
label_szczegoly_name.grid(row=1, column=5)
label_szczegoly_wartosc=Label(ramka_szczegoly_obiektow, text="....")
label_szczegoly_wartosc.grid(row=1, column=6)
label_szczegoly_post=Label(ramka_szczegoly_obiektow, text="Posty: ")
label_szczegoly_post.grid(row=1, column=7)
label_szczegoly_wartosc=Label(ramka_szczegoly_obiektow, text="....")
label_szczegoly_wartosc.grid(row=1, column=8)

#ramka_mapa
map_widget = tkintermapview.TkinterMapView(ramka_mapa, width=1200, height=500, corner_radius=0)
